        ...
        <Grid item xs={12}>
          <Paper className={classes.paper}>
            ...
            <ul className={classes.list}>
              <li>
                <span className={classes.negrita}>
                  Criterios de calidad del software. Un enfoque de Accesibilidad
                  Web vinculado a la gestión de recursos físicos.{' '}
                </span>
                III Congreso Internacional de Ciencias de la Computación y
                Sistemas de Información – 2019.
              </li>
            </ul>
          </Paper>
        </Grid>
